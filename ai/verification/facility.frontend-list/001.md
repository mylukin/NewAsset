# Verification Report: facility.frontend-list

**Run**: #001
**Date**: 2025-12-14 12:42:56 UTC
**Verdict**: ✅ PASS
...
- `ai/tasks/index.json`
- `ai/verification/facility.frontend-api/001.json`
- `ai/verification/facility.frontend-api/001.md`
- `ai/verification/index.json`
- `ai/verification/results.json`
- `ruoyi-ui/src/api/asset/facility.js`
...
[TEST] ✗ FAIL
  ...
  [INFO] Finished at: 2025-12-14T20:42:56+08:00
  [INFO] ------------------------------------------------------------------------
...
_Generated by agent-foreman verification system at 2025-12-14 12:42:56 UTC_