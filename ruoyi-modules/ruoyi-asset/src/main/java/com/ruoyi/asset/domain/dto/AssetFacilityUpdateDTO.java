...
/**
 * DTO for updating facility asset
 */
public class AssetFacilityUpdateDTO implements Serializable {

    private static final long serialVersionUID = 1L;

    // Asset ID (required for update)
    ...
    @NotBlank(message = "Facility type cannot be blank")
